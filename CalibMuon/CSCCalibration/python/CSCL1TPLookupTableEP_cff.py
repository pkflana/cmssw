...
CSCL1TPLookupTableEP = cms.ESSource(
    ...
    gemAlignCorrME11Files = cms.vstring(
        "L1Trigger/CSCTriggerPrimitives/data/GEMCSC/AlignmentCorrection/GEMCSCLUT_align_corr_es_ME11_positive_endcap_L1.txt",
        "L1Trigger/CSCTriggerPrimitives/data/GEMCSC/AlignmentCorrection/GEMCSCLUT_align_corr_es_ME11_positive_endcap_L2.txt",
        "L1Trigger/CSCTriggerPrimitives/data/GEMCSC/AlignmentCorrection/GEMCSCLUT_align_corr_es_ME11_negative_endcap_L1.txt",
        "L1Trigger/CSCTriggerPrimitives/data/GEMCSC/AlignmentCorrection/GEMCSCLUT_align_corr_es_ME11_negative_endcap_L2.txt",
    ),
    ## GEM alignment correction in ME21
    gemAlignCorrME21Files = cms.vstring(
        "L1Trigger/CSCTriggerPrimitives/data/GEMCSC/AlignmentCorrection/GEMCSCLUT_align_corr_es_ME21_positive_endcap_L1.txt",
        "L1Trigger/CSCTriggerPrimitives/data/GEMCSC/AlignmentCorrection/GEMCSCLUT_align_corr_es_ME21_positive_endcap_L2.txt",
        "L1Trigger/CSCTriggerPrimitives/data/GEMCSC/AlignmentCorrection/GEMCSCLUT_align_corr_es_ME21_negative_endcap_L1.txt",
        "L1Trigger/CSCTriggerPrimitives/data/GEMCSC/AlignmentCorrection/GEMCSCLUT_align_corr_es_ME21_negative_endcap_L2.txt",
    ),
