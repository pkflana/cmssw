...
std::unique_ptr<CSCL1TPLookupTableME11ILT> CSCL1TPLookupTableEP::produceME11ILT(const CSCL1TPLookupTableME11ILTRcd&) {
  ...
  auto GEM_align_corr_es_ME11_positive_endcap_L1_ = load_signed(gemAlignCorrME11Files_[0]);
  auto GEM_align_corr_es_ME11_positive_endcap_L2_ = load_signed(gemAlignCorrME11Files_[1]);
  auto GEM_align_corr_es_ME11_negative_endcap_L1_ = load_signed(gemAlignCorrME11Files_[2]);
  auto GEM_align_corr_es_ME11_negative_endcap_L2_ = load_signed(gemAlignCorrME11Files_[3]);
  ...
  lut->set_GEM_align_corr_es_ME11_positive_endcap_L1(std::move(GEM_align_corr_es_ME11_positive_endcap_L1_));
  lut->set_GEM_align_corr_es_ME11_positive_endcap_L2(std::move(GEM_align_corr_es_ME11_positive_endcap_L2_));
  lut->set_GEM_align_corr_es_ME11_negative_endcap_L1(std::move(GEM_align_corr_es_ME11_negative_endcap_L1_));
  lut->set_GEM_align_corr_es_ME11_negative_endcap_L2(std::move(GEM_align_corr_es_ME11_negative_endcap_L2_));
...
std::unique_ptr<CSCL1TPLookupTableME21ILT> CSCL1TPLookupTableEP::produceME21ILT(const CSCL1TPLookupTableME21ILTRcd&) {
  ...
  auto GEM_align_corr_es_ME21_positive_endcap_L1_ = load_signed(gemAlignCorrME21Files_[0]);
  auto GEM_align_corr_es_ME21_positive_endcap_L2_ = load_signed(gemAlignCorrME21Files_[1]);
  auto GEM_align_corr_es_ME21_negative_endcap_L1_ = load_signed(gemAlignCorrME21Files_[2]);
  auto GEM_align_corr_es_ME21_negative_endcap_L2_ = load_signed(gemAlignCorrME21Files_[3]);
  ...
  lut->set_GEM_align_corr_es_ME21_positive_endcap_L1(std::move(GEM_align_corr_es_ME21_positive_endcap_L1_));
  lut->set_GEM_align_corr_es_ME21_positive_endcap_L2(std::move(GEM_align_corr_es_ME21_positive_endcap_L2_));
  lut->set_GEM_align_corr_es_ME21_negative_endcap_L1(std::move(GEM_align_corr_es_ME21_negative_endcap_L1_));
  lut->set_GEM_align_corr_es_ME21_negative_endcap_L2(std::move(GEM_align_corr_es_ME21_negative_endcap_L2_));
