...
# with command line options: SingleMuPt1_pythia8_cfi -s GEN,SIM -n 10 --conditions auto:phase1_2022_realistic --beamspot DBrealistic --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry DB:Extended --era Run3 --relval 25000,100 --no_exec --fileout file:step1.root
