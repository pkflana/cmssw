...
# with command line options: step4 -s HARVESTING:validationHarvestingNoHLT+dqmHarvestingFakeHLT --conditions auto:run1_mc --mc --filetype DQM --scenario pp -n 100 --no_exec --filein file:step3_inDQM.root --fileout file:step4.root
