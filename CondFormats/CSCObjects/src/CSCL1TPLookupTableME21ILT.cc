...
CSCL1TPLookupTableME21ILT::CSCL1TPLookupTableME21ILT()
    : GEM_pad_CSC_es_ME21_even_(0),
      ...
      GEM_align_corr_es_ME21_positive_endcap_L1_(0),
      GEM_align_corr_es_ME21_positive_endcap_L2_(0),
      GEM_align_corr_es_ME21_negative_endcap_L1_(0),
      GEM_align_corr_es_ME21_negative_endcap_L2_(0),
...
void CSCL1TPLookupTableME21ILT::set_GEM_align_corr_es_ME21_positive_endcap_L1(t_lut_signed lut) {
  GEM_align_corr_es_ME21_positive_endcap_L1_ = std::move(lut);
}

void CSCL1TPLookupTableME21ILT::set_GEM_align_corr_es_ME21_positive_endcap_L2(t_lut_signed lut) {
  GEM_align_corr_es_ME21_positive_endcap_L2_ = std::move(lut);
}

void CSCL1TPLookupTableME21ILT::set_GEM_align_corr_es_ME21_negative_endcap_L1(t_lut_signed lut) {
  GEM_align_corr_es_ME21_negative_endcap_L1_ = std::move(lut);
}

void CSCL1TPLookupTableME21ILT::set_GEM_align_corr_es_ME21_negative_endcap_L2(t_lut_signed lut) {
  GEM_align_corr_es_ME21_negative_endcap_L2_ = std::move(lut);
}
...
int CSCL1TPLookupTableME21ILT::GEM_align_corr_es_ME21_positive_endcap_L1(unsigned chamber, unsigned roll) const {
  return GEM_align_corr_es_ME21_positive_endcap_L1_[16*(chamber-1)+(roll-1)];
}

int CSCL1TPLookupTableME21ILT::GEM_align_corr_es_ME21_positive_endcap_L2(unsigned chamber, unsigned roll) const {
  return GEM_align_corr_es_ME21_positive_endcap_L2_[16*(chamber-1)+(roll-1)];
}

int CSCL1TPLookupTableME21ILT::GEM_align_corr_es_ME21_negative_endcap_L1(unsigned chamber, unsigned roll) const {
  return GEM_align_corr_es_ME21_negative_endcap_L1_[16*(chamber-1)+(roll-1)];
}

int CSCL1TPLookupTableME21ILT::GEM_align_corr_es_ME21_negative_endcap_L2(unsigned chamber, unsigned roll) const {
  return GEM_align_corr_es_ME21_negative_endcap_L2_[16*(chamber-1)+(roll-1)];
}
